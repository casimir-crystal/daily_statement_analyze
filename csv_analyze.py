...
def table_export(csv_filename, form_dict, today=datetime.now()):
    ...
    table_dict['POS机GC'] = ''
    table_dict['POS机AC'] = ''
    table_dict['小程序'] = float_or_int(form_dict['xiaochengxu_turnover'])
    table_dict['小程序GC'] = float_or_int(form_dict['xiaochengxu_sells'])
    ...
    table_dict['线下AC'] = float_or_int(table_dict['线下合计'] / table_dict['线下GC'])
    table_dict['储蓄卡/福利券'] = float_or_int(csv_dict['会员卡支付']['总金额(元)'])
    table_dict['签名'] = ''
